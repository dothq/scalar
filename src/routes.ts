...
const routes = [
  { path: '/', component: Home, exact: true, title: "Dot Browser ─ The browser with privacy at heart." },

  { path: '/about', component: About, exact: true, title: "About ─ Dot HQ" },
  { path: '/about/privacy', component: AboutPrivacy, exact: true, title: "Privacy ─ Dot HQ" },
  {
  ...
  { path: '/about/terms', component: AboutTerms, exact: true, title: "Terms of Service ─ Dot HQ" },
  { path: '/about/cookies', component: AboutCookies, exact: true, title: "Cookies ─ Dot HQ" },
  { path: '/about/gdpr', component: AboutGDPR, exact: true, title: "GDPR ─ Dot HQ" },

  { path: '/products/desktop', component: Browser, exact: true, title: "Dot Browser for Desktop ─ Dot HQ" },
  { path: '/products/one', component: One, exact: true, title: "Dot One ─ Dot HQ" },
