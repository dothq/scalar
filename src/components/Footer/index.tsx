...
export const Externala = ({ href, children }: {href: string, children: any }) => (
    <a href={href}>
        {children}
    </a>
)
        ...
        <footer className={"footer"}>
            <div className={"footer-container"}>
                <div className={"footer-info"} style={{ flex: 1, width: '100%' }}>
                    <a href={'/'} style={{ width: "36px", height: "36px", display: "flex" }}>
                    ...
                    <div className={"footer-socials"}>
                        ...
                        <a href={"https://www.youtube.com/channel/UCgmXI2ccMKSTPNCij4_6Ubw"} target={"_blank"}>
