...
export const LangPicker = ({ locale, className, style, theme, menuTop, openerLocation }: { locale: any, className?: string, style?: any, theme?: number, menuTop?: string, openerLocation: string }) => {
