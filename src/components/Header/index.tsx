...
const BlogMenu = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
    <a href={"/branding"} style={{ textDecoration: "none", borderBottom: "none" }}>Branding</a>
    <a href={"/acknowledgements"} style={{ textDecoration: "none", borderBottom: "none" }}>Acknowledgements</a>
    <a href={"/licenses"} style={{ textDecoration: "none", borderBottom: "none" }}>Licenses</a>
    <a href={"/open-source"} style={{ textDecoration: "none", borderBottom: "none" }}>Open Source</a>
  </div>
)

const HelpMenu = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
    <a href={"https://support.dothq.co"} style={{ textDecoration: "none", borderBottom: "none" }}>Support Centre</a>
    <a href={"https://support.dothq.co/report-issue"} style={{ textDecoration: "none", borderBottom: "none" }}>Report an issue</a>
    <a href={"https://status.dothq.co"} style={{ textDecoration: "none", borderBottom: "none" }}>System Status</a>
  </div>
)

const AboutMenu = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
    <a href={"/about"} style={{ textDecoration: "none", borderBottom: "none" }}>About Dot HQ</a>
    <a href={"/about/open-source"} style={{ textDecoration: "none", borderBottom: "none" }}>Open Source</a>
    <a href={"/acknowledgements"} style={{ textDecoration: "none", borderBottom: "none" }}>Acknowledgements</a>
    <a href={"/about/privacy"} style={{ textDecoration: "none", borderBottom: "none" }}>Privacy Policy</a>
    <a href={"/about/terms"} style={{ textDecoration: "none", borderBottom: "none" }}>Terms of Service</a>
    <a href={"/about/gdpr"} style={{ textDecoration: "none", borderBottom: "none" }}>GDPR</a>
  </div>
)
  ...
  return (
    <>
      ...
      >
        <div className={`nav-container`}>
          ...
          <div className={'nav-center'}>
            <ul className={'nav-items'}>
              {menus.map((menu, key) => (
                <a
                  className={`aexclude ${fauxHovered === key && detachOpen ? `nav-item-selected` : ``} ${!menu.component ? `nav-item-no-arrow` : ``}`}
                  onMouseOver={() => {
                    if(menu.href) {
                      setFauxHovered(key);
                ...
                >
                  {menu.name}
                  {menu.component && <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewBox="0 0 10 6" fill="none" style={{ marginLeft: "8px" }}>
                    <path d="M9.00061 0.99997L5.00061 4.99997L1.00061 0.99997" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>}
                </a>
              ))}
            </ul>
          ...
          <div className={'nav-right'} onMouseEnter={() => onNavHoverExit()}>
            <div className={'footer-socials footer-socials-header-override'}>
              <a title={"Twitter"} className={"aexclude"} href={'https://twitter.com/DotBrowser'} target={'_blank'}>
                <i className={'twitter-icon'}></i>
              </a>
              <a title={"Discord"} className={"aexclude"} href={'https://dothq.link/dsc'} target={'_blank'}>
                <i className={'discord-icon'}></i>
              </a>
              <a title={"Matrix"} className={"aexclude"} href={'https://dothq.link/matrix'} target={'_blank'}>
        ...
        {true && <div className={"nav-desktop-menu"} tabIndex={detachOpen ? 0 : -1} style={{ width: "100%", pointerEvents: detachOpen ? `all` : `none` }}>
          <div 
