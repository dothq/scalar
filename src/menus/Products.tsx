...
export const Products = ({ id, visible, highlighted }: { id: string; visible: boolean, highlighted: number }) => {
                ...
                <div className={"menu-grid"}>
                    <MenuItem>
                        ...
                        <div>
                            ...
                            <p>A privacy-conscious web browser based on Firefox, made for Windows, macOS, and Linux.</p>
                        </div>
                    </MenuItem>
                    <MenuItem>
